#!/usr/bin/env python3
"""Generate SQL insert files for microlearn batch 1 books."""
...
def main() -> None:
    books = json.loads(Path("scripts/microlearn_batch1_books.json").read_text())
    outdir = Path("scripts/sql_batch1")
