...
const CHALLENGE_HERO_IMAGES: Record<string, number> = {
  ...
  '15K Steps Daily': require('../assets/challenge-cards/15k_steps.png'),
  '12k Steps': require('../assets/challenge-cards/10k_steps.png'),
  '12K Steps': require('../assets/challenge-cards/10k_steps.png'),
  '12k Steps Daily': require('../assets/challenge-cards/10k_steps.png'),
  '12K Steps Daily': require('../assets/challenge-cards/10k_steps.png'),
  ...
  '10K Steps Free': require('../assets/challenge-cards/10k_steps.png'),
  '8k Steps': require('../assets/challenge-cards/10k_steps.png'),
  '8K Steps': require('../assets/challenge-cards/10k_steps.png'),
  '8k Steps Daily': require('../assets/challenge-cards/10k_steps.png'),
  '8K Steps Daily': require('../assets/challenge-cards/10k_steps.png'),
